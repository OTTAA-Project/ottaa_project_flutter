...
class ProfileService implements ProfileRepository {
  ...
  Future<void> updateUserSettings(
    ...
    return await _serverRepository.updateUserSettings(
  ...
  @override
  Future<Either<String, Map<String, dynamic>>> getConnectedUsers(
      {required String userId}) async {
    return await _serverRepository.getConnectedUsers(userId: userId);
  }

  @override
  Future<Either<String, Map<String, dynamic>>> fetchConnectedUserData(
      {required String userId}) async {
  ...
  @override
  Future<Either<String, Map<String, dynamic>>> getProfileById(
      {required String id}) {
