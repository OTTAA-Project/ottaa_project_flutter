...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i16.CreateEmailToken>(
        _i17.CreateEmailTokenImpl(gh<_i8.ServerRepository>()));
    gh.singleton<_i18.CreateGroupData>(
        _i19.CreateGroupDataImpl(gh<_i8.ServerRepository>()));
    gh.singleton<_i20.CreatePhraseData>(
        _i21.CreatePhraseDataImpl(gh<_i8.ServerRepository>()));
    gh.singleton<_i22.CreatePictoData>(
        _i23.CreatePictoDataImpl(gh<_i8.ServerRepository>()));
    gh.singleton<_i24.CustomiseRepository>(
        _i25.CustomiseService(gh<_i8.ServerRepository>()));
    gh.singleton<_i26.LearnPictogram>(
        _i27.LearnPictogramImpl(serverRepository: gh<_i28.ServerRepository>()));
    gh.singleton<_i29.PredictPictogram>(_i30.PredictPictogramImpl(
        serverRepository: gh<_i28.ServerRepository>()));
    gh.singleton<_i31.ProfileRepository>(
        _i32.ProfileService(gh<_i8.ServerRepository>()));
    ...
    gh.singleton<_i35.ReportRepository>(
        _i36.ReportService(gh<_i8.ServerRepository>()));
    ...
    gh.singleton<_i40.AboutRepository>(_i41.AboutService(
      gh<_i14.AuthRepository>(),
      gh<_i28.ServerRepository>(),
      gh<_i28.LocalDatabaseRepository>(),
    ));
