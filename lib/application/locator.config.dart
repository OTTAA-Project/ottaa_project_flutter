...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    await gh.singletonAsync<_i8.RemoteConfigRepository>(
      () => _i9.RemoteConfigService.start(),
      preResolve: true,
    );
    gh.singleton<_i10.ServerRepository>(_i11.ServerService());
    gh.singleton<_i12.TTSRepository>(_i13.TTSService(gh<_i3.I18N>()));
    gh.singleton<_i14.UserSettingRepository>(
        _i15.UserSettingsService(gh<_i10.ServerRepository>()));
    gh.singleton<_i16.VerifyEmailToken>(
        _i17.VerifyEmailTokenImpl(gh<_i10.ServerRepository>()));
    gh.singleton<_i18.AuthRepository>(_i19.AuthService(
      gh<_i4.LocalDatabaseRepository>(),
      gh<_i10.ServerRepository>(),
    ));
    gh.singleton<_i20.ChatGPTRepository>(_i21.ChatGPTService(
      gh<_i22.ServerRepository>(),
      gh<_i8.RemoteConfigRepository>(),
    ));
    gh.singleton<_i23.CreateEmailToken>(
        _i24.CreateEmailTokenImpl(gh<_i10.ServerRepository>()));
    gh.singleton<_i25.CreateGroupData>(
        _i26.CreateGroupDataImpl(gh<_i10.ServerRepository>()));
    gh.singleton<_i27.CreatePhraseData>(
        _i28.CreatePhraseDataImpl(gh<_i10.ServerRepository>()));
    gh.singleton<_i29.CreatePictoData>(
        _i30.CreatePictoDataImpl(gh<_i10.ServerRepository>()));
    gh.singleton<_i31.CustomiseRepository>(
        _i32.CustomiseService(gh<_i10.ServerRepository>()));
    gh.singleton<_i33.LearnPictogram>(
        _i34.LearnPictogramImpl(serverRepository: gh<_i22.ServerRepository>()));
    gh.singleton<_i35.PredictPictogram>(_i36.PredictPictogramImpl(
        serverRepository: gh<_i22.ServerRepository>()));
    gh.singleton<_i37.ProfileRepository>(
        _i38.ProfileService(gh<_i10.ServerRepository>()));
    gh.singleton<_i39.RemoteStorageRepository>(
      _i40.MobileRemoteStorageService(
    ...
    gh.singleton<_i41.ReportRepository>(
        _i42.ReportService(gh<_i10.ServerRepository>()));
    gh.singleton<_i43.SentencesRepository>(_i44.SentencesService(
      gh<_i18.AuthRepository>(),
      gh<_i10.ServerRepository>(),
    ));
    gh.factory<_i45.WebRemoteStorageService>(
      () => _i45.WebRemoteStorageService(
        gh<_i18.AuthRepository>(),
        gh<_i10.ServerRepository>(),
        gh<_i3.I18N>(),
      ),
    ...
    gh.singleton<_i46.AboutRepository>(_i47.AboutService(
      gh<_i18.AuthRepository>(),
      gh<_i22.ServerRepository>(),
      gh<_i22.LocalDatabaseRepository>(),
    ));
    gh.singleton<_i48.GroupsRepository>(_i49.GroupsService(
      gh<_i18.AuthRepository>(),
      gh<_i39.RemoteStorageRepository>(),
      gh<_i10.ServerRepository>(),
    ));
    gh.singleton<_i50.PictogramsRepository>(_i51.PictogramsService(
      gh<_i18.AuthRepository>(),
      gh<_i10.ServerRepository>(),
      gh<_i39.RemoteStorageRepository>(),
    ));
