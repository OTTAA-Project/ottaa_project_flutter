...
class PictogramGroupsController extends GetxController{
  ...
  void addSomeScroll(ScrollController controller){
    controller.animateTo(controller.offset.toDouble() + 200, duration: Duration(milliseconds: 100), curve: Curves.ease);
  }
  ...
  void gotoPreviousPage(PageController pageController){
    pageController.previousPage(duration: Duration(milliseconds: 100), curve: Curves.easeOut);
  }
