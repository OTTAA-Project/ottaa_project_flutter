      ...
      () => Stack(
        children: [
          ...
          PictoMemoryGameWidget(
            ...
            imageUrl:
                controller.questions[controller.positions[0].value].imageUrl,
          ...
          PictoMemoryGameWidget(
            ...
            horizontalSize: horizontalSize,
            imageUrl:
                controller.questions[controller.positions[1].value].imageUrl,
          ...
          controller.difficultyLevel.value >= 1
              ? PictoMemoryGameWidget(
                  ...
                  name:
                      controller.questions[controller.positions[2].value].text,
                  verticalSize: verticalSize,
                  horizontalSize: horizontalSize,
                  imageUrl: controller
          ...
          controller.difficultyLevel.value >= 2
              ? PictoMemoryGameWidget(
                  ...
                  name:
                      controller.questions[controller.positions[3].value].text,
                  verticalSize: verticalSize,
                  horizontalSize: horizontalSize,
                  imageUrl: controller
          ...
          PictoMemoryGameWidget(
            ...
            horizontalSize: horizontalSize,
            imageUrl:
                controller.questions[controller.positions[4].value].imageUrl,
          ...
          PictoMemoryGameWidget(
            ...
            horizontalSize: horizontalSize,
            imageUrl:
                controller.questions[controller.positions[5].value].imageUrl,
          ...
          controller.difficultyLevel.value >= 1
              ? PictoMemoryGameWidget(
                  ...
                  name:
                      controller.questions[controller.positions[6].value].text,
                  verticalSize: verticalSize,
                  horizontalSize: horizontalSize,
                  imageUrl: controller
          ...
          controller.difficultyLevel.value >= 2
              ? PictoMemoryGameWidget(
                  ...
                  name:
                      controller.questions[controller.positions[7].value].text,
                  verticalSize: verticalSize,
                  horizontalSize: horizontalSize,
                  imageUrl: controller
