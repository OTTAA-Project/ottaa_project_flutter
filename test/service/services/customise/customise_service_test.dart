...
void main() {
  ...
  final fakePictos = {
    "FWy18PiX2jLwZQF6-oNZR": {
      ...
      "resource": {
        "asset": "",
        "network":
            "https://firebasestorage.googleapis.com/v0/b/ottaaproject-flutter.appspot.com/o/Archivos%20Paises%2Ficonos%2Fic_action_previous.webp?alt=media&token=a6feccd4-fd34-4b5a-ac1d-a5f027551d44"
      },
      "tags": {
        "EDAD": ["JOVEN", "NINO"]
      },
  ...
  final Map<String, Map<String, dynamic>> fakeGroups = {
    "--PHmDIFeKHvulVxNtBgk": {
      ...
      "resource": {
        "asset": "",
        "network":
            "https://firebasestorage.googleapis.com/v0/b/ottaaproject-flutter.appspot.com/o/Archivos%20Paises%2Ficonos%2Fdescripcion.webp?alt=media&token=4dbde8ba-f144-4a12-90f6-013bf68d912d"
      },
      "text": "ADJETIVOS"
    },
  ...
  test("should set shortcuts for user", () async {
    ...
    when(mockServerRepository.setShortcutsForUser(
            shortcuts: ShortcutsModel.none(), userId: ""))
    ...
    await customiseService.setShortcutsForUser(
        shortcuts: ShortcutsModel.none(), userId: "");
  ...
  test("should return the shortcuts", () async {
    when(mockServerRepository.fetchShortcutsForUser(userId: ""))
        .thenAnswer((_) async {
  ...
  test("should return a list of user groups", () async {
    when(mockServerRepository.fetchUserGroups(languageCode: "", userId: ""))
        .thenAnswer((_) async {
      return Right(fakeGroups);
    });

    final groups =
        await customiseService.fetchUserGroups(languageCode: "", userId: "");

    expect(groups.length, 2);
  });

  test("should return a list of user pictos", () async {
    when(mockServerRepository.fetchUserPictos(languageCode: "", userId: ""))
        .thenAnswer((_) async {
      return Right(fakePictos);
    });

    final pictos =
        await customiseService.fetchUserPictos(languageCode: "", userId: "");
  ...
  test("should return if a value exist or not", () async {
    ...
    final exist =
        await customiseService.valuesExistOrNot(languageCode: "", userId: "");
